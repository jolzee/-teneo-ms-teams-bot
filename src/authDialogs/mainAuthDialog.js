...
const { OAuthHelpers } = require("../lib/oAuthHelpers");
...
class MainAuthDialog extends LogoutDialog {
  constructor() {
    super("MainDialog");
  ...
  async loginStep(step) {
    ...
    if (tokenResponse) {
      ...
      return await step.prompt(TEXT_PROMPT, {
        prompt: "Would you like to do? (type 'me', 'send <EMAIL>' or 'recent')",
      });
    }
...
module.exports.MainAuthDialog = MainAuthDialog;
