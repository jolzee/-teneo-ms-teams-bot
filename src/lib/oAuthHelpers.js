...
class OAuthHelpers {
  ...
  static async sendMail(context, tokenResponse, emailAddress) {
    if (!context) {
      throw new Error(
        "OAuthHelpers.sendMail(): `context` cannot be undefined."
      );
    }
    if (!tokenResponse) {
      throw new Error(
        "OAuthHelpers.sendMail(): `tokenResponse` cannot be undefined."
      );
    }
    ...
    await context.sendActivity(
      `I sent a message to ${emailAddress} from your account.`
    );
  }
  ...
  static async listMe(context, tokenResponse) {
    ...
    if (!tokenResponse) {
      throw new Error(
        "OAuthHelpers.listMe(): `tokenResponse` cannot be undefined."
      );
    }
  ...
  static async listRecentMail(context, tokenResponse) {
    if (!context) {
      throw new Error(
        "OAuthHelpers.listRecentMail(): `context` cannot be undefined."
      );
    }
    if (!tokenResponse) {
      throw new Error(
        "OAuthHelpers.listRecentMail(): `tokenResponse` cannot be undefined."
      );
    }
